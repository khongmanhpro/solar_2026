...
export const DEFAULT_PROVINCES = [
  { code: "ho-chi-minh", name: "Hồ Chí Minh", factor: 1, displayOrder: 1 },
  { code: "ha-noi", name: "Hà Nội", factor: 0.88, displayOrder: 2 },
  { code: "da-nang", name: "Đà Nẵng", factor: 0.95, displayOrder: 3 },
  { code: "can-tho", name: "Cần Thơ", factor: 1.02, displayOrder: 4 },
  { code: "binh-duong", name: "Bình Dương", factor: 1, displayOrder: 5 },
  { code: "dong-nai", name: "Đồng Nai", factor: 1, displayOrder: 6 },
  { code: "long-an", name: "Long An", factor: 1.01, displayOrder: 7 },
  { code: "other", name: "Tỉnh/thành khác", factor: 0.92, displayOrder: 8 },
